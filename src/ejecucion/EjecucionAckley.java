...
public class EjecucionAckley {
	...
	public static void main(String[] args) throws Exception {
		...
		swingWorkerRealTime_mejor_fitness.go("Mejor fitness", "Ackley", "Iteración", "Valor fitness");

		SwingWorkerRealTime swingWorkerRealTime_fitness_total = new SwingWorkerRealTime();
		swingWorkerRealTime_fitness_total.go("Fitness total", "Ackley", "Iteración", "Valor fitness");

		SwingWorkerRealTime swingWorkerRealTime_mejores_genes_x = new SwingWorkerRealTime();
		swingWorkerRealTime_mejores_genes_x.go("Mejores genes - X", "Ackley", "Iteración", "Valor X");

		SwingWorkerRealTime swingWorkerRealTime_mejores_genes_y = new SwingWorkerRealTime();
		swingWorkerRealTime_mejores_genes_y.go("Mejores genes - Y", "Ackley", "Iteración", "Valor Y");
